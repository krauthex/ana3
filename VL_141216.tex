...
\begin{document}
	...
	\begin{proof}
		...
		\end{align*}
		Hieraus folgt zunächst $f \ast g \in L^\infty(\R^n)$.\\ %TODO: math error? actually L^1?
		...
		\end{align*}
		Für die linke Seite ist zu beachten, dass $f_k,g_k \in \ms{S}(\R^n)$ und somit auch $\wh{f_k},\wh{g_k} \in \ms{S}(\R^n)$. % and their \ast product?
