...
\begin{proof}
	...
	\end{align*}
	\footnotetext{Statt $X$ auch $A$ möglich, da $g$ auf $X\sm A =0$ ist.}
\end{proof}

\textbf{Zusatz:} Im Fall $p \in (1, \infty)$ ist $y \mapsto \lvert y \rvert^p$ strikt konvex, sodass Gleichheit impliziert, dass \\$h = \lvert f \rvert \lvert g \rvert^{1-p'}$ konstant ist, d.h. $g=0$ oder $\lvert f \rvert = \lambda \lvert g \rvert^{p'-1}$ für ein $\lambda \in \mbb{R}$. % hier ist das x evtl falsch.... ? 
